...
export default function MainPage() {
  ...
  return (
    <div className={styles.mainParent}>
      ...
      <div className={styles.sam_container}>
        <div style={{ paddingTop: '220px' }}>
          ...
          >
            Great holidays presents a part of our heritage.Here's our 2022
            take...
          </h3>
        </div>

        <div className={styles.sam_btn}>
          <button className={styles.innerBtn}>Shop for her</button>
          <button className={styles.innerBtn}>Shop for him</button>
          <button className={styles.innerBtn}>Shop for girls</button>
          <button className={styles.innerBtn}>Shop for boys</button>
          <button className={styles.innerBtn}>Shop for the home</button>
        </div>
      </div>
