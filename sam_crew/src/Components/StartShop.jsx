                ...
                <div className={styles.Sunny_1}>
                    ...
                    <div
                        ...
                        <button
                            ...
                            onClick={() => dispatch(openModal())}> START SHOPPING</button>
                ...
                <div className={styles.lastPara}>
                    <p
                        style={{
                            fontSize: 10,
                            fontWeight: "bold",
                            cursor: "pointer", }}>By clicking "start shopping," you agree to ourTerms of Use and Privacy Policy, including the
                             use ofcookiesand the transfer of your personal information to the United States, a jurisdiction that may not provide
                              an equivalent level of data protection to the laws in your home country.
                    </p>
                </div>
            </div>
        </aside>
